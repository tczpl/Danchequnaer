...
<?php
	...
	//sql语句
	$sql="SELECT name,sex,num,nali,beiju,time FROM danche WHERE nali='至善园4号'ORDER BY time DESC"; 
 ...
 <center>
  ...
  echo "<div class='weibojuzhong'><font color='#FFFFFF' size='+1'><center><b>【至善园4号】共有".$num."次单车被偷报告</b></center></font><div><br>";
